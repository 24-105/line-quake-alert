export const LOG_MESSAGES = {
  ...
  HANDLING_FOLLOW_EVENT_FAILED: 'Failed to handle follow event',
  HANDLING_UNFOLLOW_EVENT: 'Handling unfollow event',
  HANDLING_UNFOLLOW_EVENT_FAILED: 'Failed to handle unfollow event',
  ...
  HANDLING_WHERE_YOU_LIVE_FAILED: 'Failed to handle where you live',
  HANDLING_QUAKE_SEISMIC_INTENSITY: 'Handling quake seismic intensity',
  HANDLING_QUAKE_SEISMIC_INTENSITY_FAILED:
    'Failed to handle quake seismic intensity',
  HANDLING_CONTACT_ME_BY_CHAT: 'Handling contact me by chat',
  HANDLING_CONTACT_ME_BY_CHAT_FAILED: 'Failed to handle contact me by chat',
  ...
  HANDLING_WEBHOOK_EVENTS_FAILED: 'Failed to handle webhook events',
  ...
  HANDLING_HEALTH_CHECK: 'Handling health check',
  CONNECTED_TO_P2P_QUAKE_WEBSOCKET_API: 'Connected to P2P Quake WebSocket API',
  WEBSOCKET_FAILED: 'Failed to WebSocket API',
  WEBSOCKET_CONNECTION_CLOSED_RECONNECTING:
